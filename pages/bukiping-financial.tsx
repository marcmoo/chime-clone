import { BukipingFinancialComponents } from "@components/pages";
...
const FaqPage: NextPageWithLayout = () => {
  return (
    <>
      <Head>
        <title>Bukiping Financial, Inc. | Bukiping</title>
        <meta name="description" content="Bukiping Clone Financial Inc" />
      </Head>

      {/* 1 */}
      <BukipingFinancialComponents.Banner.Container>
        <BukipingFinancialComponents.Banner.BackgroundColor />

        <BukipingFinancialComponents.Banner.Title>
          Get to know Bukiping
        </BukipingFinancialComponents.Banner.Title>

        <BukipingFinancialComponents.Banner.ImageWrapper>
          <Image
            src="/static/pages/bukiping-financial/community-hero.png"
            alt="Community Hero"
            width={785}
            height={400}
          />
      ...
      <BukipingFinancialComponents.Section.Container>
        ...
        <BukipingFinancialComponents.Section.Content>
          <Disclosure label="Helpful, easy, free" opened>
            <p>
              Bukiping is a financial technology company founded on a simple idea:
            ...
            <p>
              ...
              Bukiping offers everyday consumers that choice. We helped bring
              ...
              Bukiping members never have to look far to access cash. Millions of
              people trust Bukiping every day.
            </p>
          </Disclosure>

          <Disclosure label="Aligned interests">
            <p>
              A decade ago, in the wake of the global financial crisis, Bukiping
              ...
              founded Bukiping, determined to build a company that would give
            ...
            <p>
              Bukiping&apos;s business reflects that commitment. Instead of fees
              and charges, our revenue comes mainly from transactions, the small
              amount we earn from Visa when a member uses their Bukiping card. In
      ...
      <BukipingFinancialComponents.Section.Container>
        ...
        <BukipingFinancialComponents.Section.Content>
          <Disclosure label="A new, customer-focused approach" opened>
            <p>
              Bukiping is different from other financial services companies. We
              ...
              Bukiping&apos;s new signups come from word of mouth and referrals.
            ...
            <p>
              Who are Bukiping members? They&apos;re mainstream consumers, your
          ...
          <Disclosure label="Bukiping Values">
            <p>
          ...
          <Disclosure label="Showing up">
            <p>
              As the COVID-19 pandemic hit, Bukiping saw the opportunity to make a
              ...
              gas in their cars so they could get to work. In total, Bukiping
      ...
      <BukipingFinancialComponents.Section.Container>
        ...
        <BukipingFinancialComponents.Section.Content>
          <Disclosure label="More choice, more innovation" opened>
            <p>
              Bukiping is not a bank. Instead, we partner with regional banks to
            ...
            <p>
              As a technology company, Bukiping&apos;s expertise and platform
          ...
          <Disclosure label="Transparent, trusted">
            <p>
              Nothing is more important at Bukiping than safeguarding members&apos;
              ...
              Bukiping has made significant investments in people and technology to
            ...
            <p>
              Bukiping has built a world-class team to manage risk, including
          ...
          <Disclosure label="Regulated">
            <p>
              Bukiping&apos;s work is supervised by our partner banks,{" "}
              ...
              federal level, Bukiping is also subject to the jurisdiction of the
              Consumer Financial Protection Bureau (CFPB), the Federal Trade
              Commission (FTC), and the Department of Justice (DOJ). At the
              state level, Bukiping is regulated by agencies focused on consumer
            ...
            <p>
              Bukiping’s financial products are always designed in coordination
      ...
      <BukipingFinancialComponents.Section.Container>
        ...
        <BukipingFinancialComponents.Section.Content>
          <Disclosure label="Building a foundation" opened>
            <p>
              Bukiping has members in all 50 states, each experiencing their own
          ...
          <Disclosure label="Creating impact">
            <p>
              Bukiping distributed more than $600,000 in grants in 2020 to support
            ...
            <p>
              Bukiping backs organizations and causes that work for racial and
            ...
            <p>
              As a Pledge 1% member, Bukiping employees can use 1% of their work
              time to volunteer and give back. Bukipingers can create their own
          ...
          <Disclosure label="Passionate people">
            <p>
              Bukiping is headquartered in San Francisco, with offices in Chicago
              and Vancouver. Although Bukipingers come from many different
            ...
            <p>
              Bukipingers are engineers and customer service professionals,
            ...
            <p>
              Bukiping is committed to building a diverse workforce at both the
              employee and leadership level. We believe Bukiping&apos;s open and
              supportive culture inspires our employees to do an even better job
              serving members. In 2021 alone, Bukiping was named to Fortune&apos;s
